...
docker run -it -p 8500:8500 -m=10g --cpus=8 -v /Users/tobe/code/simple_tensorflow_serving:/host simple-tensorflow-serving bash
...
docker run -it -p 8501:8501 -m=10g --cpus=8 -v /Users/tobe/code/simple_tensorflow_serving:/host simple-tensorflow-serving bash
...
docker run -it -m=10g --cpus=8 -p 8502:8502 -p 8503:8503 -v /Users/tobe/code/simple_tensorflow_serving:/host tensorflow-serving bash
